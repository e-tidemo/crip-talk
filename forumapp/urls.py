...
urlpatterns = [
    ...
    path('wall_of_complaints/', views.WallOfComplaintsView.as_view(),
         name='wall_of_complaints'),
    ...
    path('edit-comment/<int:pk>/', views.CommentUpdateView.as_view(),
         name='edit-comment'),
    path('delete-post/<slug:slug>/', views.PostDeleteView.as_view(),
         name='delete-post'),
